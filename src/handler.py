...
class WebHandler(socketserver.BaseRequestHandler):
    ...
    def gen_response (self, parsed):
        if (parsed["method"] != "GET"):
            return self._gen_headers (HTTPRes.IMPLEMENTED, parsed["version"]), HTTPRes.IMPLEMENTED
